...
| G4 | **Recordatorios por WhatsApp** (enlaces `wa.me` + email de seguridad) | ✅ En curso | Plan cerrado en `docs/PLAN-WHATSAPP.md`. Implementado: `normalizarTelefono`, `textoWhatsApp`, `buildWaLink`, pestaña "WhatsApp" auto-creada con enlaces RichText y casillas ✅, trigger 10:00 (preparación + email a sin teléfono), trigger 22:00 (refuerzo conservando ✅ + email a sin marcar). Tests: 78/78 pasando. |
